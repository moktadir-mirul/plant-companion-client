...
const HeroSlider = () => {
  ...
  return (
    <div className="w-11/12 py-5 mx-auto slider-container">
      <Slider {...settings}>
        <div className="relative bg-[url(./assets/hero-slide1.jpg)] bg-no-repeat bg-cover w-11/12 mx-auto h-[450px] rounded-2xl text-black slide-1">
        ...
        <div className="relative bg-[url(./assets/slide-2.jpg)] bg-no-repeat bg-cover w-11/12 mx-auto h-[450px] rounded-2xl slide-2 text-white">
        ...
        <div className="relative bg-[url(./assets/hero-slide-3.webp)] bg-no-repeat bg-cover w-11/12 mx-auto h-[450px] rounded-2xl slide-3 text-white">
          <div className="w-full h-full p-10 flex flex-col items-center justify-center gap-5">

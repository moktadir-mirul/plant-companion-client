...
const Footer = () => {
  ...
  return (
    <div ref={footerRef} className="w-full bg-green-100 dark:bg-green-950 text-gray-300 pt-10 px-10 pb-2">
      <div className="w-11/12 mx-auto flex gap-5 lg:gap-0 flex-col lg:flex-row justify-between items-center lg:items-start pb-5">
        <div className="flex-1 flex flex-col justify-center items-center gap-2">
          ...
          <p className="text-green-900 dark:text-gray-300 text-center text-sm">
            Your go-to plant care tracker for healthier, happier plants. Stay connected and grow with us! make it long
          </p>
        </div>
        ...
        <div className="flex-1 text-green-950 dark:text-gray-300 text-center space-y-2">
            ...
            <h1 className="flex flex-col md:flex-row gap-2 items-center justify-center"><MdEmail size={30} color="darkgreen"></MdEmail> info@plantcompanion.com</h1>
            <h1 className="flex flex-col md:flex-row gap-2 items-center justify-center"><FaPhoneAlt size={25} color="darkgreen"/> +88-01711-140802</h1>
            <h1 className="flex flex-col md:flex-row gap-2 items-center justify-center text-center"><IoLocation size={30} color="darkgreen"/>Uttara, Dhaka, Bangladesh</h1>
        </div>
      </div>
      <div>
        <hr className="text-green-800 dark:text-gray-300" />
        <div className="text-green-950 dark:text-gray-300 py-5">
          <h1 className="text-center font-bold text-green-800 dark:text-gray-300">Connect With Us</h1>
          ...
          <h1 className="text-center text-sm dark:text-gray-300 text-green-800">© 2025 Plant Companion. All rights reserved. </h1>
        </div>
      </div>
    </div>
  );
